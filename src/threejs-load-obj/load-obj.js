/**
 * Demonstrates how to load OBJ models.
 * 
 * Credits: https://threejsfundamentals.org/threejs/lessons/threejs-load-obj.html
 *
 */
...
function main() {
...

  {
    ...
    mtlLoader.load('./resources/windmill-fixed.mtl', (mtlParseResult) => {
      const objLoader = new OBJLoader2();
      const materials =  MtlObjBridge.addMaterialsFromMtlLoader(mtlParseResult);
      objLoader.addMaterials(materials);
      objLoader.load('./resources/windmill.obj', (root) => {
        windmill = root;
        scene.add(root);
